...
const products = [
  ...
  },
  {
    ...
    tag: "POPULAR",
    desc: "A nourishing blend of premium grains flower for swallow.",
  },
  {
    id: "mixed",
  ...
  {
    id: "garri",
    name: "Original Ijebu Garri",
    category: "swallow",
    price: 2000,
    img: "ijebu-garri.png",
    tag: "BEST SELLER",
    desc: "Smooth cassava flour for rich, traditional Garri.",
  },
  {
    id: "ewedu",
    name: "Dry Ewedu",
...
function sendWhatsApp(text) {
  ...
  // Navigate the current tab so popup blockers cannot prevent WhatsApp from opening.
...
$("#checkoutForm").addEventListener("submit", (e) => {
  ...
  const message = buildWhatsApp(data);
